...
heading tags : <h1>heading 1</h1>, <h2>heading 2</h2>, ... etc 
img tag: <img src="source file" alt="text" height="" width="">
table tags: <table></table>, <thead></thead>, <tbody></tbody>, <tr>Table Rows</tr>, <td></td>, <td colspan="2">Table data</td>, <td rowspan="2">Table data</td>.
Lists: unordered list <ul></ul>, <ul type="square"></ul>, ordered list <ol></ol>, defination list: <dl> <dt>Term</dt> <dd>Defination</dd> </dl> 
